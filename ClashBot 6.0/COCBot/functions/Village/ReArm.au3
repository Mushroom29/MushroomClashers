...
Func ReArm()
	...
	;Xbow
	Local $offColors[3][3] = [[0x95673D, 31, 26], [0xEF6CEE, 70, 7], [0xF2F6F5, 76, 0]]; xbow, elixir, edge
	Local $XbowPixel = _MultiPixelSearch($x1, $y1, $x2, $y2, 1, 1, Hex(0xB2A79C, 6), $offColors, 30) ; button start
	...
	;Inferno
	Local $offColors[3][3] = [[0xF82D08, 22, 18], [0x5E4B68, 69, 7], [0xF2F6F5, 76, 0]]; inferno, dark, edge
	Local $InfernoPixel = _MultiPixelSearch($x1, $y1, $x2, $y2, 1, 1, Hex(0xB2A79C, 6), $offColors, 30)
